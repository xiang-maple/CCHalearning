...
namespace L4_type_transform_and_string_format_change
{
    internal class L4Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine($"the number is {height}");

            //float o = 3.0f;
            //Console.WriteLine("number: "+ o);
            //Console.WriteLine("shui", o);  // there are different from python can use , to connectdifferent data type (pyhthon)
            //float f = 3;  // 3 - 3.0
            //Console.WriteLine(f);
            //f += 0.12f;
            //Console.WriteLine(f);
            ...
            //Console.WriteLine("me age is: " + age);  // first way plus connect
            ...
            //Console.WriteLine("{0} like {1}", name, mm);
